...
class PythonDialog (object):
    ...
    def __init__(self, main_window,tag=0,image_path=''):
        ...
        # Changed by Me
        if tag == 0:
            self.app = None #main_window._app
        else:
            self.app = None #main_window._app
        self._TAG=tag
    ...
    def show(self):
        ...
        if self._TAG == 0:
            ...
            self.output_text("Press Ctrl+Enter to inser the Equation. Ready...\n", "info")
        elif self._TAG == 4:
            self.output_text("Press Ctrl+Enter to save the Equation. Ready...\n", "info")
    ...
    def execute_buffer(self):
        ...
        buf = self.editor.get_buffer()
        # Added by Me
        self.main_window.emit("window-request", "restore")
        #
