...
class RichTextImage (RichTextAnchor):
    ...
    def write(self, filename):
        """Write image to file"""
        print "richtextbuffer.py:write image to a filename"   
    ...
    def write_stream(self, stream, filename="image.png"):
        ...
        """
        print "richtextbuffer.py:write image to stream in richtextbuffer"
        #print filename
        def write(buf):
            stream.write(buf)
            #print buf
        ...
        #msg=self._pixbuf.get_option("tEXt::tag")
        #print "write stream tag"
        #print msg
        #msg=self._pixbuf_original.get_option("tEXt::tag")
        #print msg
    ...
    def copy(self):
        ...
        print "richtextbuffer.py:copy image in richtextbuffer"
        ...
        if self._pixbuf:
            ...
            tag=img._pixbuf.get_option("tEXt::tag")
            print "Tag is"
            print tag
    ...
    def set_from_file(self, filename):
        print "richtextbuffer.py:set_from_file"
    ...
    def set_from_stream(self, stream):
        print "richtextbuffer.py:set from stream"
    ...
    def set_from_pixbuf(self, pixbuf, filename=None):
        ...
        print "richtextbuffer.py: set from pixbuf"
    ...
    def set_from_url(self, url, filename=None):
        """Set image by url"""
        print "richtextbuffer.py: set from url"
        imgfile = None        
    ...
    def scale(self, width, height, set_widget=True):
        ...
        print "richtextbuffer: Image Scaling"
        if not self.is_valid:
            return
        
        self._size = [width, height]
        #tag=self._pixbuf.get_option("tEXt::tag")
        #print "Tag is"
        #print tag
        ...
        if not self.is_size_set():
            ...
            # perform scaling
            try: 
               tag=self._pixbuf_original.get_option("tEXt::tag")
               print "2a) Tag is"
               print tag
            except Exception:
               print "Except"
